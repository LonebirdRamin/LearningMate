...
const SubmitAssignment = () => {
  ...
  const goSubmit = async () => {
    ...
    //   };
      ...
      const studentIdResponse = await fetch(`http://192.168.1.179:5001/api/getStudentIdFromEmail?email=${email}`)
      ...
      const assignmentDueDateResponse = await fetch(`http://192.168.1.179:5001/api/getAssignmentDueDate?assignmentID=${assID}`)
    ...
    //   const assIDresponse = await fetch(`http://192.168.1.179:5001/api/getSpecificAssignmentID?assignmentName=${assName}`)
    //   if (!assIDresponse.ok) {
    ...
    //   console.log("ASSIGNMENT ID = ", assignID);
      ...
      const response = await axios.post('http://192.168.1.179:5001/api/submitAssignment', submitData)
